...
기존 ECG 이상 탐지 연구는 주로 ECG 전체 신호를 관찰한 뒤 정상과 이상을 분류하는 데 초점을 맞추어 왔습니다. 최근에는 조기 경보(Early Warning)를 통해 보다 빠른 탐지를 시도하는 연구가 활발히 진행되고 있으나, 대부분 사전에 정의된 고정된 관찰 구간(Time Slice)을 기반으로 판단을 수행합니다.
